...
var hasher_256 = new SHA3(256);

var EdDSA = require('elliptic').eddsa;
var ec = new EdDSA('ed25519');

var CryptoHelper__B = {};
CryptoHelper__B.ec = ec;
CryptoHelper__B.hasher = hasher;
CryptoHelper__B.hasher_256 = hasher_256;
console.log('CryptoHelper__B loaded...');

global.CHelper__B  = CryptoHelper__B;
//var key = CryptoHelper__B.ec.keyFromSecret('ababa17823978312798913784234234');
//console.log(key.getPublic());

/*
// Create key pair from secret//80241cd5abacacde4e540365c380c9fe637b34f64c0884873956a08fb1fdd70cdb829d61aebe54b83fefa40f88ec76c32c2abfa65f0db656d2c43389e0a47e4f
var key = ec.keyFromSecret('ababa4234234'); // hex string, array or Buffer

// Sign the message's hash (input must be an array, or a hex-string)
var msgHash = 'aaaa111bbbeeeef9827348793249783427798342fff';
var signature = key.sign(msgHash).toHex();

var actualSig = '' + signature;//'F15114F8C16B0BEF44A2781A6DF8AED5F41811566ADAB2939CF459EDDDF20298614B93094A13D37079F229F66D8DD5D15FFC82006CACA19A59477DE9676C4807';
//console.log('signature:::');
//console.log((''+signature));
// Verify signature
console.log(key.verify(msgHash, actualSig));


//CHECK W NO PRIVATE KEY
//console.log(key.getPublic());
var pub = key.getPublic();//'';
var key2 = ec.keyFromPublic(pub, 'hex');

//Verify signature
var signature2 = '' + actualSig;
console.log(key2.verify(msgHash, signature2));


//Benis private key:
var privateKey = 'benisslilsecret';
//Benis public key
privateKey = hash.update(privateKey).digest();
hash.reset();
*/

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"elliptic":4,"sha3":36}],2:[function(require,module,exports){
...
},{"buffer":50}],3:[function(require,module,exports){
var r;
...
},{"crypto":50}],4:[function(require,module,exports){
'use strict';
...
module.exports={
  ...
  "_spec": "elliptic",
  "_where": "/Users/bhag/Desktop/gsvcore2",
  "author": {
    "name": "Fedor Indutny",
...
},{"./sponge":37,"buffer":51}],37:[function(require,module,exports){
...
},{"./permute":40,"buffer":51}],38:[function(require,module,exports){
...
},{"../copy":39}],39:[function(require,module,exports){
...
},{"./chi":38,"./iota":41,"./rho-pi":43,"./theta":47}],41:[function(require,module,exports){
...
},{"../xor":48,"./round-constants":42}],42:[function(require,module,exports){
...
},{"../copy":39,"../rotate":46,"./pi-shuffles":44,"./rho-offsets":45}],44:[function(require,module,exports){
...
},{"../copy":39,"../rotate":46,"../xor":48}],48:[function(require,module,exports){
